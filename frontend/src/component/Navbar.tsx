...
function Navbar() {
  ...
  return (
    <header className="flex items-center justify-between bg-gradient-to-r from-indigo-500 to-purple-500 px-6 py-4 shadow-md flex-wrap gap-4 text-white">
      <h2 className="text-xl font-bold">Welcome, Safeedha 👋</h2>
      <div className="flex items-center gap-4 flex-wrap">
        ...
        <button className="flex items-center bg-red-500 text-white px-3 py-1 rounded hover:bg-red-600 text-sm transition">
